...
ALTER TABLE dim_bondsname
ADD CONSTRAINT UC_gold_world_gov_bonds_BondID
UNIQUE(BondID);
...
ALTER TABLE dim_daydate
ADD CONSTRAINT UC_gold_world_gov_bonds_DateID
UNIQUE(DateID);
...
ALTER TABLE dim_month
ADD CONSTRAINT UC_gold_world_gov_bonds_dim_month
UNIQUE(MonthID);
...
ALTER TABLE dim_quarter
ADD CONSTRAINT UC_gold_world_gov_bonds_dim_quarter
UNIQUE(QuarterID);
...
ALTER TABLE dim_year
ADD CONSTRAINT UC_gold_world_gov_bonds_dim_year
UNIQUE(YearID);
...
ALTER TABLE dim_country
ADD CONSTRAINT UC_gold_world_gov_bonds_dim_country
UNIQUE(CountryID);
...
ALTER TABLE dim_region
ADD CONSTRAINT UC_gold_world_gov_bonds_dim_region
UNIQUE(RegionID);
